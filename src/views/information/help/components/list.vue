      ...
      <el-card v-if="schema" v-loading="loading" class="box-card pt0">
        <div slot="header" class="header flex">
          ...
          <el-button
            ...
            type="primary"
            size="mini"
            @click="common.openWindow('/information/help/create',{id:999999})"
          >创建新文章</el-button>
        </div>
        <el-table
          v-if="listData"
            ...
            <template slot-scope="scope">
              <el-button-group>
                <el-button
                  ...
                  type="primary"
                  size="mini"
                  @click="common.openWindow('/information/help/detail',{id:scope.row.id})"
                >查看</el-button>
                <el-button
                  v-operatePriv="{priv:'site:article:update'}"
                  plain
                  size="mini"
                  @click="common.openWindow('/information/help/detail',{id:scope.row.id,edit:true})"
                >编辑</el-button>
                <el-button
