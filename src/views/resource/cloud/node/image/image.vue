    ...
    <div class="fatherBox">
      ...
      <el-card v-if="schema" v-loading="loading" class="box-card pt0">
        <div slot="header" class="header flex">
          ...
          <el-button
            v-operatePriv="{priv:'resource:cloud:node:image:create'}"
            type="primary"
            size="mini"
        ...
        >
          ...
          <el-table-column prop="code" :label="schema.output.code"></el-table-column>
          ...
          <el-table-column prop="osVersion.name" :label="schema.output.osVersion[':title']"></el-table-column>
          <el-table-column prop="glanceId" :label="schema.output.glanceId"></el-table-column>
          <el-table-column
          ...
          <el-table-column fixed="right" label="操作" width="100">
            <template slot-scope="scope">
              <el-button
                v-operatePriv="{priv:'resource:cloud:node:image:detail'}"
                plain
                type="primary"
                size="mini"
