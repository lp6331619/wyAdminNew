    ...
    <div class="fatherBox">
      ...
      <el-card v-if="schema" v-loading="loading" class="box-card pt0">
        <div slot="header" class="header flex">
          <div>节点-线路列表 ({{ page.totals }})</div>
          <el-button
            v-operatePriv="{priv:'resource:cloud:node:line:create'}"
            type="primary"
            size="mini"
        ...
        >
          ...
          <el-table-column prop="bandwidth.value" :label="schema.output.bandwidth[':title']"></el-table-column>
          ...
          <el-table-column fixed="right" label="操作" width="100">
            <template slot-scope="scope">
              <el-button
                v-operatePriv="{priv:'resource:cloud:node:line:detail'}"
                plain
                type="primary"
                size="mini"
