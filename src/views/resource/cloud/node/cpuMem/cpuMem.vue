    ...
    <div class="fatherBox">
      ...
      <el-card v-if="schema" v-loading="loading" class="box-card pt0">
        <div slot="header" class="header flex">
          ...
          <el-button
            v-operatePriv="{priv:'resource:cloud:node:cpu_mem:create'}"
            type="primary"
            size="mini"
        ...
        >
          ...
          <el-table-column prop="flavorId" :label="schema.output.flavorId"></el-table-column>
          <el-table-column prop="cpu" :label="schema.output.cpu"></el-table-column>
          <el-table-column prop="mem.value" :label="schema.output.mem[':title']"></el-table-column>
          <el-table-column
          ...
          <el-table-column fixed="right" label="操作" width="100">
            <template slot-scope="scope">
              <el-button
                v-operatePriv="{priv:'resource:cloud:node:cpu_mem:detail'}"
                plain
                type="primary"
                size="mini"
...
<script>
import cpuMemJs from './cpuMem'
export default cpuMemJs
</script>
