    ...
    <div class="fatherBox">
      ...
      <el-card v-if="schema && listData" v-loading="loading" class="box-card pt0">
        <div slot="header" class="header flex">
          ...
          <el-button
            v-operatePriv="{priv:'resource:idc:device:type:create'}"
            type="primary"
            size="mini"
        ...
        >
          <el-table-column prop="id" :label="schema.output.id" sortable="custom" width="100"></el-table-column>
          <el-table-column prop="name" :label="schema.output.name"></el-table-column>
          <el-table-column prop="category.name" :label="schema.output.category[':title']"></el-table-column>
          <el-table-column
          ...
          <el-table-column fixed="right" label="操作" width="135">
            <template slot-scope="scope">
              <el-button-group>
                <el-button
                  v-operatePriv="{priv:'resource:idc:device:type:detail'}"
                  plain
                  type="primary"
                  size="mini"
                ...
                >查看</el-button>
                <el-button
                  v-operatePriv="{priv:'resource:idc:device:type:delete'}"
                  plain
                  type="danger"
                  size="mini"
                  @click="del(scope.row)"
