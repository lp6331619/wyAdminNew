    ...
    <div class="fatherBox">
      ...
      <el-card v-if="schema" v-loading="loading" class="box-card pt0">
        <div slot="header" class="header flex">
          ...
          <el-button
            v-operatePriv="{priv:'resource:idc:cidr:create'}"
            type="primary"
            size="mini"
        ...
        >
          ...
          <el-table-column prop="cidr" :label="schema.output.cidr" sortable="custom" width="130"></el-table-column>
          ...
          <el-table-column prop="innerStatus.name" :label="schema.output.innerStatus[':title']"></el-table-column>

          <el-table-column fixed="right" label="操作" width="135">
            <template slot-scope="scope">
              <el-button-group>
                <el-button
                  v-operatePriv="{priv:'resource:idc:cidr:detail'}"
                  plain
                  type="primary"
                  size="mini"
                ...
                >查看</el-button>
                <el-button
                  v-operatePriv="{priv:'resource:idc:cidr:delete'}"
                  plain
                  type="danger"
                  size="mini"
                  @click="del(scope.row)"
