        ...
        <el-table-column prop="id" label="会员 ID" sortable="custom" width="100">
          <template slot-scope="scope">
            <el-button
              type="text"
              size="small"
              @click.native.prevent="$router.push({path:'/member/list/detail',query:{id:scope.row.id}})"
        ...
        <el-table-column fixed="right" label="操作" width="120">
          <template slot-scope="scope">
            <el-button
              ...
              @click.native.prevent="$router.push({path:'/member/list/detail',query:{id:scope.row.id}})"
            >管理</el-button>
            <el-button type="text" size="small" @click.native.prevent="toMember(scope.row.id)">登录账号</el-button>
          </template>
        </el-table-column>
      </el-table>
